...
- Repository: `https://github.com/vinodreddy1999/metam-services.git`
- Branch: `main`
- Source commit before deployment: `bf1f927`
- Application: `Metam Services`
- Docker image: `vinodreddy1999/metam-services-fullstack`
- Tags: `latest`, `0.2.2`
- Deployment environment: Local Docker Desktop Linux engine
- Runtime container: `metam-fullstack-validation`
...
- Persistent data volume: `metam_fullstack_data:/data`
...
```bash
docker build -t vinodreddy1999/metam-services-fullstack:latest -t vinodreddy1999/metam-services-fullstack:0.2.2 .
```
...
#22 naming to docker.io/vinodreddy1999/metam-services-fullstack:latest done
#22 naming to docker.io/vinodreddy1999/metam-services-fullstack:0.2.2 done
#22 DONE 0.3s
```
...
vinodreddy1999/metam-services-fullstack   0.2.2     22a408206046   11 hours ago   546MB
vinodreddy1999/metam-services-fullstack   latest    22a408206046   11 hours ago   546MB
```
...
```bash
docker push vinodreddy1999/metam-services-fullstack:0.2.2
...
Mounts=[{"Destination":"/data","Name":"metam_fullstack_data","RW":true,"Type":"volume"}]
```

Commands:

```bash
docker stop metam-fullstack-validation
docker rm metam-fullstack-validation
docker run -d --name metam-fullstack-validation -p 8080:8080 -v metam_fullstack_data:/data vinodreddy1999/metam-services-fullstack:latest
```
...
metam-fullstack-validation   vinodreddy1999/metam-services-fullstack:latest   Up 17 seconds   0.0.0.0:8080->8080/tcp, [::]:8080->8080/tcp
```
...
```text
status=ok runtime=python-fastapi service=metam-services
```
