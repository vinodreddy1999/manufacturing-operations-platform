...
class SupplierPortalRepository:
    def __init__(self) -> None:
        ...
        self.purchase_orders = [
            {"id": "po-apex-001", "purchase_order_id": "po-apex-001", "po_number": "PO-9001", "supplier_id": "supplier-apex", "po_date": str(date.today()), "delivery_date": str(date.today() + timedelta(days=6)), "status": "Issued", "buyer_contact": "buyer@metam.local", "delivery_address": "Hyderabad Plant", "delivery_instructions": "Deliver to gate 2", "document_requirements": ["Invoice", "Test certificate"], "items": [{"item_id": "item-steel", "description": "Steel coil", "ordered_quantity": 1000, "pending_quantity": 1000, "uom": "KG"}]},
            {"id": "po-other-001", "purchase_order_id": "po-other-001", "po_number": "PO-OTHER", "supplier_id": "supplier-mech", "po_date": str(date.today()), "delivery_date": str(date.today() + timedelta(days=10)), "status": "Issued", "buyer_contact": "buyer@metam.local", "delivery_address": "Hyderabad Plant", "delivery_instructions": "Internal", "document_requirements": [], "items": []},
        ]
